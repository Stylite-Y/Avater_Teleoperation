//
// Created by wooden on 2020/6/18.
//

#include "rt/MedianFilter.h"
...
double MEDIANFILTER_Insert(sMedianFilter_t *medianFilter, float sample)
{
    unsigned int i;
    ...
    return (double)medianFilter->medianHead->value;
}