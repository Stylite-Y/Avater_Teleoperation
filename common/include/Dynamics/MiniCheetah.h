...
#ifndef PROJECT_BlankPanther_H
#define PROJECT_BlankPanther_H
...
//    cheetah._jointDryFriction = .2;
    ...
    // rotorRotationalInertiaZ << 55, 0, 0, 0, 55, 0, 0, 0, 103;
   rotorRotationalInertiaZ << 0, 0, 0, 0, 0, 0, 0, 0, 0;
    ...
    Vec3<T> abadCOM(0, 0.0588, 0);  // LEFT
    ...
    hipRotationalInertia = hipRotationalInertia * 1e-6;//*2.0;
    ...
    kneeRotationalInertiaRotated = kneeRotationalInertiaRotated * 1e-6;//*2.0;
    ...
    bodyRotationalInertia << 16269, 0, 0, 0, 50813, 0, 0, 0, 60989;
    bodyRotationalInertia = bodyRotationalInertia * 1e-6;
//    bodyRotationalInertia = bodyRotationalInertia * 1e-6 * 0.5;
    ...
    // locations
    cheetah._abadRotorLocation = Vec3<T>(0.129, 0.051, 0);
