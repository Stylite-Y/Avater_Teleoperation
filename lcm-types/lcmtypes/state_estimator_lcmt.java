...
public final class state_estimator_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x7d7a1920807b2a28L;
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        for (int a = 0; a < 4; a++) {
            outs.writeFloat(this.contact[a]); 
        }
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.contact = new float[(int) 4];
        for (int a = 0; a < 4; a++) {
            this.contact[a] = ins.readFloat();
        }
    ...
    public lcmtypes.state_estimator_lcmt copy()
    {
        ...
        outobj.contact = new float[(int) 4];
