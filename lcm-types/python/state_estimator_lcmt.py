...
class state_estimator_lcmt(object):
    __slots__ = ["p", "vWorld", "vBody", "rpy", "omegaBody", "omegaWorld", "quat", "contact"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[3], [3], [3], [3], [3], [3], [4], [4]]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>4f', *self.contact[:4]))
    ...
    def _decode_one(buf):
        ...
        self.contact = struct.unpack('>4f', buf.read(16))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x7d7a1920807b2a28) & 0xffffffffffffffff
